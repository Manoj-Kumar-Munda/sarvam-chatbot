...
export const SchemaDisplayPath = ({
  ...
  return (
    <span
      ...
      // biome-ignore lint/correctness/useExhaustiveDependencies: "needed for parameter highlighting"
      // @ts-expect-error: children might be a complex type but we want to render it if present
